...
class PageSourceFollower(
...
) : PagingSource<Int, ModelFollower>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ModelFollower> {
    ...
    override fun getRefreshKey(state: PagingState<Int, ModelFollower>): Int? {
